...
CREATE TABLE QRTZ_SIMPROP_TRIGGERS (
  ...
  BOOL_PROP_1 TEXT NULL,
  BOOL_PROP_2 TEXT NULL,
  TIME_ZONE_ID TEXT NULL,
  PRIMARY KEY (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP),
  FOREIGN KEY (SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP)
    REFERENCES QRTZ_TRIGGERS(SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP)
...
CREATE TABLE QRTZ_FIRED_TRIGGERS (
  ...
  JOB_NAME TEXT NULL,
  JOB_GROUP TEXT NULL,
  IS_NONCONCURRENT TEXT NULL,
  REQUESTS_RECOVERY TEXT NULL,
...
CREATE INDEX IDX_QRTZ_T_NFT_ST_MISFIRE_GRP    ON QRTZ_TRIGGERS(SCHED_NAME, TRIGGER_STATE, MISFIRE_INSTR, NEXT_FIRE_TIME, TRIGGER_GROUP);
